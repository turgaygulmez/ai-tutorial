...
Check out [the example](./LangChain/example1.js) which does the same thing as OpenAI first example.
...
If you need to construct complext prompt with system and user, you can still do so. See [example](./LangChain/example2.js)
...
See [Example](./LangChain/example3.js)
...
Check [example](./LangChain/example4.js)
